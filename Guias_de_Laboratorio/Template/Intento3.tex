...
\title{\practica}    
\author{autor}
\institute{Laboratorio de Fisica II para Quimicos}
\date{date/date}

\abstract{Estudio experimental de la Ley de Inducción de Faraday usando un generador de funciones
y un osciloscopio o un sistema de toma de datos con una computadora.
 \PACS{esto}}
\maketitle
